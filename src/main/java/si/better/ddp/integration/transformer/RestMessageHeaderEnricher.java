 ...
 */
@Component
public class RestMessageHeaderEnricher
{
    @Transformer(inputChannel = "restFileInputChannel", outputChannel = "headerBasedRouterChannel")
    public Message<?> enrich(Message<File> fileMessage)
    {
        return MessageUtil.enrichMessageHeader(fileMessage, Source.API);
    }
